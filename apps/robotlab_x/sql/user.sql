-- managed
-- SQL migration for user table in robotlab_x
...
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "external_id" TEXT;
...
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "roles" JSONB;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "permissions" JSONB;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "status" TEXT;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "auth_provider" TEXT;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "password_hash" TEXT;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "password_updated_at" BIGINT;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "is_mfa_enabled" BOOLEAN;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "totp_secret" TEXT;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "login_count" BIGINT;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "last_login" BIGINT;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "last_unsuccessful_login" BIGINT;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "failed_login_count" BIGINT;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "locked_until" BIGINT;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "accepted_tos_date" BIGINT;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "created" BIGINT;
ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "modified" BIGINT;
